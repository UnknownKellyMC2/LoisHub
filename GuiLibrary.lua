...
function Lib.Window(Argstable)
	local Title = Argstable.Title and Argstable["Title"] or "UI"
	...
	function TabSys.CreateTab(Argstable)
		local TabTitle = Argstable.TitleTab and Argstable["TitleTab"] or "Tab"
		...
		function Content.CreateButton(Argstable)
			
            local BtnTitle = Argstable.Text and Argstable["Text"] or "Button"
		...
		function Content.CreateSlider(Argstable)
			local SliderTitle = Argstable.Text and Argstable["Text"] or "Slider"
			local minvalue = Argstable.Min and Argstable["Min"] or 16
			local maxvalue = Argstable.Max and Argstable["Max"] or 100
			local defaultvalue = Argstable.Default and Argstable["Default"] or minvalue
			local callback = Argstable.Function and Argstable["Function"] or function() end

            local Value = defaultvalue
            local initialFillSize = ((defaultvalue - minvalue) / (maxvalue - minvalue)) * 206
			...
			SliderFill.Size = UDim2.new(0, initialFillSize, 0, 7)
			SliderFill.ZIndex = 5
		...
		function Content.CreateKeybind(Argstable)
			local KeybindTitle = Argstable.Text and Argstable["Text"] or "Keybind"
			local oldKey = first.Name
			local first = Argstable.Default and Argstable["Default"] or Enum.KeyCode.D
			local callback = Argstable.Function and Argstable["Function"] or function() end
		...
		function Content.CreateLabel(LabelTitle)
		    local LabelTitle = Argstable.Text and Argstable["Text"] and LabelTitle or "Label"
		...
		function Content.CreateDivider(DividerTitle)
		    local DividerTitle = Argstable.Text and Argstable["Text"] and DividerTitle or "Divider"
